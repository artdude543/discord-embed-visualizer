                    ...
                    <div className={ visualizerClasses.root }>
                        <Paper className={ visualizerClasses.message }>
                            ...
                            <Paper
                                ...
                                style={{
                                    borderLeftColor: `#${embed.color && embed.color.charAt(0) === '#' ? embed.color.substring(1) : embed.color}` || green[500],
                                    display: 'grid',
                                }}
                            >
                                <div className={ embedClasses.grid }>
                                    ...
                                    { embed.image?.url && (
                                            <img
                                                ...
                                                src={ embed.image.url }
                                                style={{
                                                    width: embed.image.width !== 0 ? `${embed.image.width}px` : undefined,
                                                    height: embed.image.height !== 0 ? `${embed.image.height}px`  : undefined
                                                }}
                                            />
                                        )
                                    }
                                    ...
                                    { embed.thumbnail?.url && (
                                            <img
                                                ...
                                                style={{
                                                    width: embed.thumbnail.width !== 0 ? `${embed.thumbnail.width}px` : undefined,
                                                    height: embed.thumbnail.height !== 0 ? `${embed.thumbnail.height}px` : undefined,
                                                }}
                                            />
                                        )
                                    }
